<template>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4"
    ...
    <a href="#" class="center-navy" v-show=showsign||showsignz >
        <p class="btn-light">Đăng nhập </p>
    </a>
      <button @click="hand(data-widget)">dfn</button>
    <a href="#" class="center-navy" v-show=showsign||showsignz >
        <p class="white">Đăng ký </p>
    </a>
      <!-- Sidebar -->
...
<!--            </a>-->
<!--          </li>-->
          <li class="nav-header">Các chức vụ</li>
          <li class="nav-item">
            <a href="#" class="nav-link">
...
export default {
  data(){
    ...
    //
    //     toggleButton.addEventListener('shown.lte.pushmenu', this.handleExpandedEvent);
    // },
    methods: {
        hand(aba) {
            alert(aba)
